...
import com.github.neshkeev.coroutines.CoroutineTKind.CoroutineTMonad;
...
public class CoroutinePlayground {
    ...
    private static void simpleWriterCoroutine() {
        final CoroutineTMonad<@NotNull Unit, WriterTKind.@NotNull mu<@NotNull String, Id.@NotNull mu>> m = getCoroutineMonad();
...
//    > {
//
//    public CoroutineTKind1(@NotNull CoroutineT<R, M, A> delegate) {
//        super(delegate);
//    }
//
//    @NotNull
